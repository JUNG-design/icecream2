      ...
      .then((res) => {
        try {
          ...
          $("#upload_menual").prepend(
            '<input id="is_MenualName" type="hidden" name="is_MenualName" value="' +
          ...
          setTimeout(
            function () {
              if (type == "file") {
                ...
                $("#uploadimg").remove();
                $("#upload_img").prepend(
                  '<img id="uploadimg" src="' + this.state.file + '"/>'
                );
                $("#upload_img").prepend(
                  '<input id="is_MainImg" type="hidden" name="is_MainImg" value="' +
                    this.state.fileName +
                    '"}/>'
                );
              } else if (type == "file2") {
                ...
                $("#uploadimg2").remove();
                $("#upload_img2").prepend(
                  '<img id="uploadimg2" src="' + this.state.file2 + '"/>'
                );
                $("#upload_img2").prepend(
                  '<input id="is_LabelImg" type="hidden" name="is_LabelImg" value="' +
          ...
          <div class="bo_w re1_wrap re1_wrap_writer">
            <form name="frm" id="frm" action="" onsubmit="" method="post">
              <input
                ...
                type="hidden"
                name="is_Email"
                value={this.state.admin_userid}
              />
              <input
                id="is_Swtcode"
                type="hidden"
                name="is_Swtcode"
                value={this.state.swtcode}
              />
              <input
                id="is_beforeSwtcode"
                type="hidden"
